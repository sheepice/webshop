...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('goods', '0002_alter_goodsgroup_options_alter_goodsgroup_image'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.SmallIntegerField(help_text='商品数量', verbose_name='商品数量')),
                ('is_checked', models.BooleanField(help_text='是否选中', verbose_name='是否选中')),
